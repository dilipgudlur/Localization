...
public class RMSFileStream extends FileStream {
  //private RMSHeader header;
  boolean useMultipleFiles = false;

  public RMSFileStream(String filename) throws Exception {
    super(filename);
  }

  public RMSFileStream(String filename, boolean overwrite) throws Exception {
    this(filename, overwrite, false);
  }

  public RMSFileStream(String filename, boolean overwrite, boolean multiple) throws Exception {
