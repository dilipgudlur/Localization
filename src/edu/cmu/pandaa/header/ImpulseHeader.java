...
public class ImpulseHeader extends StreamHeader implements Serializable {
  ...
  public class ImpulseFrame extends StreamFrame implements Serializable {
    ...
    public ImpulseFrame(StreamFrame prototype, int[] peaks, short[] magnitudes) {
      super(prototype);
      peakOffsets = peaks;
    ...
    public ImpulseFrame prepend(ImpulseFrame a) {
      ...
      return new ImpulseFrame(b, peaks, mags);
    }
  }
  ...
  public ImpulseFrame makeFrame(StreamFrame prototype, List<Integer> peaks, List<Short> magnitudes) {
    if (prototype == null) {
      return null;
    }
    int size = peaks.size();
    ...
    return new ImpulseFrame(prototype, peakOffsets, peakMagnitudes);
  }
